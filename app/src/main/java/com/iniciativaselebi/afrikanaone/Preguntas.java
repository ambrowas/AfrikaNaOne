...
public class Preguntas extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (!isSolutionDisplayed) {
                    ...
                    if (selectedRadioButtonId == -1) {
                        Toast.makeText(Preguntas.this, "Don't be scared, make a choice", Toast.LENGTH_SHORT).show();
                    ...
                    if (selectedRadioButton != null) {
                        ...
                        Toast.makeText(Preguntas.this, "Unexpected error.", Toast.LENGTH_SHORT).show();
                        isAlertDisplayed = true;
    ...
    private void processAnswer() {
        ...
        if (incorrectAnswers >= 5) {
            showCustomDialog("Game Over", "You made 5 errors", new DialogInterface.OnClickListener() {
    ...
    private void processPenaltyForLeavingApp() {
        ...
        if (questionInProgress && incorrectAnswers < 4) {
            ...
            AlertDialog dialog = new AlertDialog.Builder(Preguntas.this)
                    .setTitle("Warning")
                    .setMessage("Don't leave the app during an active question.")
...
// Finally, show the dialog
    ...
    private void applyPenalty() {
        ...
        if (incorrectAnswers >= 5) {
            Toast.makeText(getApplicationContext(), "YOU MADE FIVE ERRORS.\n" +
