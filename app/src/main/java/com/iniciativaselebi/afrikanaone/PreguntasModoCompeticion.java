...
public class PreguntasModoCompeticion extends  AppCompatActivity{
            ...
            public void onClick(View v) {
                if (!isSolutionDisplayed) {
                    ...
                    if (selectedRadioButtonId == -1) {
                        Toast.makeText(PreguntasModoCompeticion.this, "Don't be scared. Make a choice", Toast.LENGTH_SHORT).show();
                    ...
                    if (selectedRadioButton != null) {
                        ...
                        Toast.makeText(PreguntasModoCompeticion.this, "Unexpected error.", Toast.LENGTH_SHORT).show();
                        isAlertDisplayed = true;
    ...
    private void displayQuestion()  {
        ...
        if (!isFinishing() && !isDestroyed()) {
            Glide.with(this)
                    .load(imageUrl)
                    .error(R.drawable.afrikanaonelogo)
                    .into(quizImage);
        }
    ...
    private void processAnswer() {
        ...
        textviewaciertos.setText("CORRECT ANS: " + correctAnswers);
        textviewpuntuacion.setText("SCORE: " + score);
        textviewfallos.setText("ERRORS: " + incorrectAnswers);

        if (incorrectAnswers >= 4 && !hasShownToast) {
            textviewfallos.setTextColor(Color.RED);
            showCustomDialog("Attention", "4 errors; One more and you're done");
            hasShownToast = true;
        }

        if (incorrectAnswers >= 5) {
            showCustomDialog("Game over", "You made five errors", new DialogInterface.OnClickListener() {
                ...
                userRef.updateChildren(updates).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            // The update failed
                            Toast.makeText(PreguntasModoCompeticion.this, "Something went wrong. Try again", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void showProgressDialog() {
        if (progressDialog == null) {
            ...
            builder.setMessage("DOWNLOADING QUESTIONS");
    ...
    private void processPenaltyForLeavingApp() {
        ...
        if (questionInProgress && incorrectAnswers < 4) {
            ...
            new AlertDialog.Builder(PreguntasModoCompeticion.this)
                    .setTitle("Warning")
                    .setMessage("Do not leave the app during an active question.")
    ...
    private void applyPenalty() {
        ...
        if (incorrectAnswers >= 5) {
            Toast.makeText(getApplicationContext(), "YOU'VE MADE FIVE ERRORS.\n" +
